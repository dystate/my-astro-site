    ...
    <section className="relative flex h-dvh flex-col items-center justify-center bg-[#F3F4ED] overflow-hidden">
      ...
      <div className="absolute left-0 bottom-0 text-left max-w-[70vw] sm:max-w-sm p-4 sm:p-8">
        <motion.div
          ...
          className="font-instrument text-[38px] sm:text-[38px] md:text-[46px] leading-[0.95] tracking-tight text-[#1a1a1a] mb-2 sm:mb-3"
        >
        ...
        <motion.div
          ...
          className="font-sans text-[18px] sm:text-[22px] md:text-[22px] font-normal leading-relaxed text-[#1a1a1a]/60"
        >
          Hi, this is Dystate.
